...
function divideu128(value: { parts: any[] }) {
...
function multiply64x2(left: Long, right: Long) {
  if (!left && !right) {
...
function lessThan(left: Long, right: Long) {
...
export default class Decimal128 {
  public _bsontype!: { value: 'Decimal128' };
  ...
  static fromString(string: string) {
    ...
    let significandHigh: [number, number]|Long = [0, 0];
    // The low 17 digits of the significand
    let significandLow: [number, number]|Long  = [0, 0];
    // The biased exponent
